...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+17,"funct7_5", false,-1);
    tracep->declBus(c+19,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+20,"Op_5", false,-1);
    tracep->declBus(c+6,"ALUctrl", false,-1, 2,0);
    ...
    tracep->declBus(c+66,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+21,"Imm", false,-1, 31,7);
    tracep->declBus(c+14,"ImmSrc", false,-1, 2,0);
    tracep->declBus(c+2,"ImmExt", false,-1, 31,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+66,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+63,"clk", false,-1);
    tracep->declBus(c+22,"instr_19_15", false,-1, 19,15);
    tracep->declBus(c+23,"instr_24_20", false,-1, 24,20);
    tracep->declBus(c+24,"instr_11_7", false,-1, 11,7);
    tracep->declBus(c+6,"ALUctrl", false,-1, 2,0);
    tracep->declBit(c+8,"ALUSrc", false,-1);
    tracep->declBit(c+7,"RegWrite", false,-1);
    tracep->declBus(c+13,"Result", false,-1, 31,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+16,((7U & (vlSelf->top__DOT__instr 
                                    >> 0xcU))),3);
    bufp->fullBit(oldp+17,((1U & (vlSelf->top__DOT__instr 
                                  >> 0x1eU))));
    bufp->fullBit(oldp+18,(vlSelf->top__DOT__decode__DOT__control_unit__DOT__branch));
    bufp->fullCData(oldp+19,(vlSelf->top__DOT__decode__DOT__control_unit__DOT__ALUOp),2);
    bufp->fullBit(oldp+20,((1U & (vlSelf->top__DOT__instr 
                                  >> 5U))));
    bufp->fullIData(oldp+21,((vlSelf->top__DOT__instr 
                              >> 7U)),25);
