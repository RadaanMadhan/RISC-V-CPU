...
VL_ATTR_COLD void Vdut___024root___initial__TOP__0(Vdut___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 131072, 0, std::string{"data.hex"}
                 ...
                 , 0x10000U, ~0ULL);
    VL_WRITEF("Finished Loading data memory\nLoading instructions....\n");
...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    vlSelf->top__DOT__PcOp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__execute__DOT__ALUop1 = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__execute__DOT__ALUop2_f = VL_RAND_RESET_I(32);
